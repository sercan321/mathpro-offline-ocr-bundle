...
class FullAppRegressionCourtGuardV172Q131Policy {
  const FullAppRegressionCourtGuardV172Q131Policy._();

  static const String phase = 'V172-Q131';
  static const String verifierScript = 'tool/verify_full_app_regression_court_guard_v172_q131.mjs';
  static const String reportJson = 'tool/reports/full_app_regression_court_guard_v172_q131_report.json';
  static const String expectedStatus = 'Q131_FULL_APP_REGRESSION_COURT_PACKAGE_READY_BUT_RUNTIME_BINDING_EVIDENCE_BLOCKED';
  ...
  static const String prerequisite = 'Q130 Graph/History/Solution runtime binding evidence';
  ...
  static FullAppRegressionCourtGuardReadiness evaluateReadiness({
    ...
    if (!explicitApproval) blockers.add('explicit Q131 approval is missing');
    ...
    return FullAppRegressionCourtGuardReadiness(
...
class FullAppRegressionCourtGuardReadiness {
  const FullAppRegressionCourtGuardReadiness({
