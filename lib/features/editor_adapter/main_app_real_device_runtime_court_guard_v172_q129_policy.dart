...
class MainAppRealDeviceRuntimeCourtGuardV172Q129Policy {
  const MainAppRealDeviceRuntimeCourtGuardV172Q129Policy._();

  static const String phase = 'V172-Q129';
  static const String verifierScript = 'tool/verify_main_app_real_device_runtime_court_guard_v172_q129.mjs';
  static const String reportJson = 'tool/reports/main_app_real_device_runtime_court_guard_v172_q129_report.json';
  static const String expectedStatus = 'Q129_MAIN_APP_REAL_DEVICE_RUNTIME_COURT_PACKAGE_READY_BUT_ACTIVATION_EVIDENCE_BLOCKED';
  ...
  static const String prerequisite = 'Q128 flag-gated activation evidence';
  ...
  static MainAppRealDeviceRuntimeCourtGuardReadiness evaluateReadiness({
    ...
    if (!explicitApproval) blockers.add('explicit Q129 approval is missing');
    ...
    return MainAppRealDeviceRuntimeCourtGuardReadiness(
...
class MainAppRealDeviceRuntimeCourtGuardReadiness {
  const MainAppRealDeviceRuntimeCourtGuardReadiness({
