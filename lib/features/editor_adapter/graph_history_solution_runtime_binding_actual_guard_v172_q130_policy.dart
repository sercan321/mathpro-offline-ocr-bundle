...
class GraphHistorySolutionRuntimeBindingActualGuardV172Q130Policy {
  const GraphHistorySolutionRuntimeBindingActualGuardV172Q130Policy._();

  static const String phase = 'V172-Q130';
  static const String verifierScript = 'tool/verify_graph_history_solution_runtime_binding_actual_guard_v172_q130.mjs';
  static const String reportJson = 'tool/reports/graph_history_solution_runtime_binding_actual_guard_v172_q130_report.json';
  static const String expectedStatus = 'Q130_GRAPH_HISTORY_SOLUTION_RUNTIME_BINDING_ACTUAL_PACKAGE_READY_BUT_MAIN_APP_EVIDENCE_BLOCKED';
  ...
  static const String prerequisite = 'Q129 main-app runtime court evidence';
  ...
  static GraphHistorySolutionRuntimeBindingActualGuardReadiness evaluateReadiness({
    ...
    if (!explicitApproval) blockers.add('explicit Q130 approval is missing');
    ...
    return GraphHistorySolutionRuntimeBindingActualGuardReadiness(
...
class GraphHistorySolutionRuntimeBindingActualGuardReadiness {
  const GraphHistorySolutionRuntimeBindingActualGuardReadiness({
