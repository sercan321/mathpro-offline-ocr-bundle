...
## Protected Runtime/UI Files Not Changed

- Keyboard files
- MORE/template tray files
- Long-press popup files
- MathLive production editor and bridge files
- Graph/Solution/History files
- AppShell/main/workspace runtime files
- AndroidManifest and MainActivity
