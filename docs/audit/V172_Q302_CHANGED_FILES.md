...
## Modified For Manifest / Documentation
...
- MORE/template tray
- Long-press inventory/list files
- MathLive production HTML/JS bridge/surface
- Graph/Solution/History runtime files
- AppShell/main/workspace runtime files
- Camera capture shell runtime
- AndroidManifest/MainActivity
- Splash/icon assets and startup code
- `pubspec.yaml`
- Android Gradle/Kotlin/toolchain files
