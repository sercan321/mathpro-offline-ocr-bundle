...
const phase = "V172-Q129";
const expectedStatus = "Q129_MAIN_APP_REAL_DEVICE_RUNTIME_COURT_PACKAGE_READY_BUT_ACTIVATION_EVIDENCE_BLOCKED";
const previousScript = "tool/verify_main_editor_activation_behind_flag_execution_guard_v172_q128.mjs";
...
const requiredMarkers = [
  ...
  [
    "lib/features/editor_adapter/main_app_real_device_runtime_court_guard_v172_q129_policy.dart",
    "Q129_MAIN_APP_REAL_DEVICE_RUNTIME_COURT_PACKAGE_READY_BUT_ACTIVATION_EVIDENCE_BLOCKED"
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q129MainAppRealDeviceRuntimeCourtGuardPhase\": \"V172-Q129\""
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q129MaySwitchDefaultEditorNow\": false"
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q129MayDeleteLegacyCursor\": false"
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q129MayClaimReleasePass\": false"
  ],
  [
    "lib/logic/mathpro_package_contract.dart",
    "q129MainAppRealDeviceRuntimeCourtGuardRule"
  ],
  [
    "README.md",
...
const combined = [read('assets/mathlive/manifest.json'), read("lib/features/editor_adapter/main_app_real_device_runtime_court_guard_v172_q129_policy.dart"), read('README.md')].join('\n');
...
const protectedSurfacesUnchanged = protectedFiles.every((rel) => fileExists(rel) && !read(rel).includes(phase) && !read(rel).includes("q129MainAppRealDeviceRuntimeCourtGuard"));
...
const outJson = "tool/reports/main_app_real_device_runtime_court_guard_v172_q129_report.json";
