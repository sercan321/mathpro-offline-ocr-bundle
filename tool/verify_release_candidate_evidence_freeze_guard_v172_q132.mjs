...
const phase = "V172-Q132";
const expectedStatus = "Q132_RELEASE_CANDIDATE_EVIDENCE_FREEZE_PACKAGE_READY_BUT_REGRESSION_EVIDENCE_BLOCKED";
const previousScript = "tool/verify_full_app_regression_court_guard_v172_q131.mjs";
...
const requiredMarkers = [
  ...
  [
    "lib/features/editor_adapter/release_candidate_evidence_freeze_guard_v172_q132_policy.dart",
    "Q132_RELEASE_CANDIDATE_EVIDENCE_FREEZE_PACKAGE_READY_BUT_REGRESSION_EVIDENCE_BLOCKED"
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q132ReleaseCandidateEvidenceFreezeGuardPhase\": \"V172-Q132\""
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q132MaySwitchDefaultEditorNow\": false"
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q132MayDeleteLegacyCursor\": false"
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q132MayClaimReleasePass\": false"
  ],
  [
    "lib/logic/mathpro_package_contract.dart",
    "q132ReleaseCandidateEvidenceFreezeGuardRule"
  ],
  [
    "README.md",
...
const combined = [read('assets/mathlive/manifest.json'), read("lib/features/editor_adapter/release_candidate_evidence_freeze_guard_v172_q132_policy.dart"), read('README.md')].join('\n');
...
const protectedSurfacesUnchanged = protectedFiles.every((rel) => fileExists(rel) && !read(rel).includes(phase) && !read(rel).includes("q132ReleaseCandidateEvidenceFreezeGuard"));
...
const outJson = "tool/reports/release_candidate_evidence_freeze_guard_v172_q132_report.json";
