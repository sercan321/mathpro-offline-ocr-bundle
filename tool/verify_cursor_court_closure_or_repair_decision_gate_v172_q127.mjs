...
const phase = "V172-Q127";
const expectedStatus = "Q127_CURSOR_COURT_CLOSURE_OR_REPAIR_DECISION_PACKAGE_READY_BUT_DEVICE_EVIDENCE_REQUIRED";
const previousScript = "tool/verify_local_evidence_reconciliation_intake_guard_v172_q126.mjs";
...
const requiredMarkers = [
  ...
  [
    "lib/features/editor_adapter/cursor_court_closure_or_repair_decision_gate_v172_q127_policy.dart",
    "Q127_CURSOR_COURT_CLOSURE_OR_REPAIR_DECISION_PACKAGE_READY_BUT_DEVICE_EVIDENCE_REQUIRED"
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q127CursorCourtClosureOrRepairDecisionGatePhase\": \"V172-Q127\""
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q127MaySwitchDefaultEditorNow\": false"
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q127MayDeleteLegacyCursor\": false"
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q127MayClaimReleasePass\": false"
  ],
  [
    "lib/logic/mathpro_package_contract.dart",
    "q127CursorCourtClosureOrRepairDecisionGateRule"
  ],
  [
    "README.md",
...
const combined = [read('assets/mathlive/manifest.json'), read("lib/features/editor_adapter/cursor_court_closure_or_repair_decision_gate_v172_q127_policy.dart"), read('README.md')].join('\n');
...
const protectedSurfacesUnchanged = protectedFiles.every((rel) => fileExists(rel) && !read(rel).includes(phase) && !read(rel).includes("q127CursorCourtClosureOrRepairDecisionGate"));
...
const outJson = "tool/reports/cursor_court_closure_or_repair_decision_gate_v172_q127_report.json";
