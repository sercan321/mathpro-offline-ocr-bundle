...
const phase = "V172-Q128";
const expectedStatus = "Q128_MAIN_EDITOR_ACTIVATION_BEHIND_FLAG_PACKAGE_READY_BUT_CURSOR_EVIDENCE_BLOCKED";
const previousScript = "tool/verify_cursor_court_closure_or_repair_decision_gate_v172_q127.mjs";
...
const requiredMarkers = [
  ...
  [
    "lib/features/editor_adapter/main_editor_activation_behind_flag_execution_guard_v172_q128_policy.dart",
    "Q128_MAIN_EDITOR_ACTIVATION_BEHIND_FLAG_PACKAGE_READY_BUT_CURSOR_EVIDENCE_BLOCKED"
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q128MainEditorActivationBehindFlagExecutionGuardPhase\": \"V172-Q128\""
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q128MaySwitchDefaultEditorNow\": false"
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q128MayDeleteLegacyCursor\": false"
  ],
  [
    "assets/mathlive/manifest.json",
    "\"q128MayClaimReleasePass\": false"
  ],
  [
    "lib/logic/mathpro_package_contract.dart",
    "q128MainEditorActivationBehindFlagExecutionGuardRule"
  ],
  [
    "README.md",
...
const combined = [read('assets/mathlive/manifest.json'), read("lib/features/editor_adapter/main_editor_activation_behind_flag_execution_guard_v172_q128_policy.dart"), read('README.md')].join('\n');
...
const protectedSurfacesUnchanged = protectedFiles.every((rel) => fileExists(rel) && !read(rel).includes(phase) && !read(rel).includes("q128MainEditorActivationBehindFlagExecutionGuard"));
...
const outJson = "tool/reports/main_editor_activation_behind_flag_execution_guard_v172_q128_report.json";
